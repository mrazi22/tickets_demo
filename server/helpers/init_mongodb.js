...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/SINAL'; // Default connection string
const DB_NAME = process.env.DB_NAME || 'SINAL'; // Default database name
